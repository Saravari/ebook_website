                ...
                <div class="card">
                  ...
                  <form method="POST" action="{{route('admin.books.update', $book->id)}}">
                        ...
                        <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input type="image" id="image" class="form-control" name="image"
                                            aria-label="Image" aria-describedby="button-image"  data-preview="holder" value="{{$book->image}}" >
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary" type="button" id="button-image">انتخاب</button>
                                        </div>
                                    </div>
                                    <img id="holder" style="margin-top:15px; max-height:100px;" src="{{$book->image}}" >
                        </div>
