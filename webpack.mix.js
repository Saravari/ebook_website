 ...
 */
    ...
    mix.styles(['resources/views/front/lib/bootstrap/css/bootstrap.min.css',
   ...
   mix.scripts(['resources/views/front/lib/jquery/jquery.min.js',
   ...
   'resources/views/front/js/main.js'], 'public/front/js/app.js');